...
//! `Instruction::set_alias` where the corpus uses one, and arrangement /
...
fn decode_perm_misc(word: u32, features: FeatureSet, out: &mut Instruction) {
    ...
    match op2016 {
        ...
        0b00001 => {
            ...
            out.set_alias(Mnemonic::Compact);
